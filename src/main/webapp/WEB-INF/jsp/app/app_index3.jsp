      ...
      <el-aside width="230px">
        <el-menu text-color="#BFCBD9"
          ...
          <el-submenu index="1">
            ...
            <el-menu-item index="1-1" @click="menuItemClick('https://www.baidu.com/','百度')">百度一下，你就知道</el-menu-item>
            <el-menu-item index="1-2" @click="menuItemClick('/viplist3','会员加油')">会员加油</el-menu-item>
            <el-menu-item index="1-3" @click="menuItemClick('/ugas3','非会员加油')">非会员加油</el-menu-item>
            <el-menu-item index="1-4" @click="menuItemClick('/maintain3','临时维修')">临时维修</el-menu-item>
          </el-submenu>
          <el-submenu index="2">
            <template slot="title">用户反馈</template>
            <el-menu-item index="2-1" @click="menuItemClick('/feedback3','用户反馈')">用户反馈</el-menu-item>
          </el-submenu>
          <el-submenu index="3">
            <template slot="title">紧急救援</template>
            <el-menu-item index="3-1" @click="menuItemClick('/help3','紧急求救')">紧急求救</el-menu-item>
          </el-submenu>
        </el-menu>
      </el-aside>
      <el-main>
