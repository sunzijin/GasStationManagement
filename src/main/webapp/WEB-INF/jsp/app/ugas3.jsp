    ...
    <el-dialog
        ...
        <el-form
            ...
            <el-form-item class="text_right">
                <el-button type="primary" @click='onSubmitAdd("myform")'>确 定</el-button>
...
<script>
    ...
    var app = new Vue({
        ...
        methods: {
            ...
            //响应注册用户对话框 保存按钮
            onSubmitAdd:function (index) {
                this.mymodel2={
                    sId:'1',
                    sMoney:this.tempsMoney+(this.mymodel1.gUMoney*this.mymodel.gasnum)
                }
                if(this.mymodel.gasnum<=0)
                {
                    ...
                    axios.put("/sales/", this.mymodel2).then(res => {
                        // 操作成功
                        this.$message({
                            message: "此次加油费用为:"+this.mymodel1.gUMoney*this.mymodel.gasnum+"元!",
                            type: "success"
                        });
